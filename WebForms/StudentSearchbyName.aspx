<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.master" AutoEventWireup="true" CodeFile="StudentSearchbyName.aspx.cs" Inherits="WebForms_StudentSearchbyName" %>
                        ...
                        <asp:GridView ID="gvStudentDetails" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MOTHER_NAME" HeaderText="Mother Name" />
                                 ...
                                 <asp:TemplateField>
                                    <HeaderTemplate>Collect</HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnCollectFee" runat="server" ImageUrl="~/Resources/edit.jpg" Height="15px" Width="15px" OnClick="btnCollectFee_Click" />
                                        <asp:HiddenField ID="hfFEEStudentID" runat="server" Value='<%#Eval("STUDENT_ID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
