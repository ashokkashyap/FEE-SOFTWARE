<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.master" AutoEventWireup="true"
    CodeFile="collectFeeNew.aspx.cs" Inherits="WebForms_collectFeeNew" %>
                ...
                <tr>
                    ...
                    <td class="Calibri14N" style="padding-left: 10px; border-bottom: 1px ridge grey;
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDate"
                            ErrorMessage="*" ForeColor="Red" ValidationGroup="v1"></asp:RequiredFieldValidator>
                            <%--<asp:RegularExpressionValidator ID="rev1" runat="server" ControlToValidate="txtDate" ErrorMessage="*"  ValidationExpression="dd-MMMM-yyyy" ForeColor="Red"></asp:RegularExpressionValidator>--%>
                    </td>
                    <td class="Calibri14N" style="border-bottom: 1px ridge grey; width: 25%;">
                        ...
                        <ajax:CalendarExtender ID="CalE" runat="server" Format="dd-MMMM-yyyy" PopupButtonID="txtDate"
