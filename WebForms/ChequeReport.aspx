<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.master" AutoEventWireup="true" CodeFile="ChequeReport.aspx.cs" Inherits="WebForms_ChequeReport" %>
        ...
        <asp:Panel ID="mainPanel" runat="server">
            <table cellpadding="0" cellspacing="5" width="90%" border="0" style="border-color: Black;">
                ...
                <tr>
                    ...
                    <td> Select Cts Type
                        <asp:DropDownList ID="ddlcts" runat="server">

                            <asp:ListItem>SELECT</asp:ListItem>
                            <asp:ListItem>CTS</asp:ListItem>
                            <asp:ListItem>NON CTS</asp:ListItem>
                            <asp:ListItem>ALL</asp:ListItem>

                        </asp:DropDownList>
                        <asp:CheckBox ID="chklessdetails" Text="Check For Less Details" runat="server" />
                    </td>
