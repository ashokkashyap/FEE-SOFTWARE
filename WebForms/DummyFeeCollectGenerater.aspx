<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.master" AutoEventWireup="true" CodeFile="DummyFeeCollectGenerater.aspx.cs" Inherits="WebForms_DummyFeeCollectGenerater" %>
                        ...
                        <asp:Panel ID="pnlStudentDetails" runat="server" BorderStyle="Dotted" BorderColor="Black" BorderWidth="1px">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="Calibri14N" style="border-bottom: 1px ridge grey; vertical-align: top;">:
                                        <asp:DropDownList ID="ddlSelectPaymentMode" AutoPostBack="true" runat="server" 
