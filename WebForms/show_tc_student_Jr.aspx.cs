...
public partial class WebForms_show_tc_student_Jr : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string varSubmitMessage = "<script language='javascript' type='text/javascript'>alert('Successfully Restored'); window.location.href = 'show_tc_student_Jr.aspx?SMD=" + Convert.ToString(Request.QueryString["SMD"]) + "&MMD=" + Convert.ToString(Request.QueryString["MMD"]) + "';</script>";
