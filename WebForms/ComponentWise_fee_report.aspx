<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.master" AutoEventWireup="true" CodeFile="ComponentWise_fee_report.aspx.cs" Inherits="WebForms_ComponentWise_fee_report" %>
        ...
        <asp:Panel ID="mainPanel" runat="server">
         ...
         <asp:Panel ID="Panel1" runat="server">
            <table cellpadding="0" cellspacing="5" width="90%" border="0" style="border-color: Black;">
                ...
                <tr>
                    <td colspan="4">
                        <br /><asp:Label ID="lblinfo2" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="Calibri14N" style="padding-left: 15px; border-bottom: 1px ridge grey;
                        width: 23%; letter-spacing: 1px;">
                        Start Date
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtStartDate2"
                            ErrorMessage="*" ForeColor="Red" ValidationGroup="v11"></asp:RequiredFieldValidator>
                    </td>
                    <td style="border-bottom: 1px ridge grey; width:30%">
                        :<asp:TextBox ID="txtStartDate2" runat="server" Width="90%"></asp:TextBox>
                        <ajax:CalendarExtender ID="CalendarExtender2" runat="server" Format="D" PopupButtonID="txtStartDate2" TargetControlID="txtStartDate2"></ajax:CalendarExtender>
                    </td>
                    <td class="Calibri14N" style="padding-left: 5px; border-bottom: 1px ridge grey;
                        width: 23%; letter-spacing: 1px;">
                        End Date
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtEndDate2"
                            ErrorMessage="*" ForeColor="Red" ValidationGroup="v11"></asp:RequiredFieldValidator>
                    </td>
                    <td style="border-bottom: 1px ridge grey; width:30%;">
                        :<asp:TextBox ID="txtEndDate2" runat="server" Width="90%"></asp:TextBox>
                        <ajax:CalendarExtender ID="CalendarExtender3" runat="server" Format="D" PopupButtonID="txtEndDate2" TargetControlID="txtEndDate2"></ajax:CalendarExtender>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4" align="center">
                        ...
                        <asp:ImageButton ID="btnsubmit" runat="server"  
                            ValidationGroup="v11" Height="18px" Width="18px" 
                            ImageUrl="~/Resources/search.png" onclick="btnsubmit_Click" />
                            <asp:ImageButton ID="btnexlcheque" runat="server" 
                            Height="22px" Width="22px" ImageUrl="~/Resources/excel-logo.jpg" 
                            Visible="false" onclick="btnexlcheque_Click" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4" align="left">
                        <br />
                        <div style="max-height:600px; max-width:1600px; overflow:auto;">
                            <asp:Panel ID="panlcheque" runat="server">
                            </asp:Panel>
                        </div>
                    </td>
                </tr>
