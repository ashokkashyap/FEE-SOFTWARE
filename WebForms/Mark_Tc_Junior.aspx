<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.master" AutoEventWireup="true" CodeFile="Mark_Tc_Junior.aspx.cs" Inherits="WebForms_Mark_Tc_Junior" %>
            ...
            <table cellpadding="0" cellspacing="0" width="90%">
                <tr>
                    <td valign="bottom" align="left" 
                        ...
                        colspan="2">
                        <div style="background-color:#FFFF99; border-top:2px solid #FFAB60; border-left:2px solid #FFAB60; border-right:2px solid #FFAB60; border-top-left-radius:25px 50px; border-top-right-radius:25px 50px; width:230px; height:25px; padding-left:8px;">
                            MARK STUDENT TC
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" colspan="2" >
                        ...
                        <asp:TextBox ID="txtAdmNoSrch" runat="server" ></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtAdmNoSrch"
                                        ErrorMessage="*" ForeColor="Red" Font-Bold="true" Font-Size="Large"></asp:RequiredFieldValidator>
                        <asp:Button ID="btnSearch"  runat="server" onclick="btnSearch_Click" Text="SEARCH" />
                         ...
                         <td class="style2">
                             ...
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                 ControlToValidate="txtLeftOnDate" ErrorMessage="*" ForeColor="Red" 
                                 InitialValue="" ValidationGroup="ADD"></asp:RequiredFieldValidator>
                             <td class="style1" style="padding-left:10px; ">
                                 :
                                 <asp:TextBox ID="txtLeftOnDate" runat="server" Width="75%" ></asp:TextBox>
                                 <ajax:CalendarExtender ID="CalendarExtender2" runat="server" 
                                     Format="dd-MMMM-yyyy" PopupButtonID="CalLeftOnDate" 
                                     TargetControlID="txtLeftOnDate">
                                 </ajax:CalendarExtender>
                                 <asp:ImageButton ID="CalLeftOnDate" runat="server" Height="18px" 
                                     ImageUrl="~/Resources/calendarGreen.jpg" Width="18px" />
                             </td>
                         ...
                         </table><asp:CheckBox ID="chktc" Text="Check For TC" runat="server" /></td>
                ...
                <tr>
                    <td align="center" colspan="2">
                        <br />
                        <asp:ImageButton ID="btnUpdate" runat="server" ImageUrl="~/Resources/submit.jpg" ValidationGroup="ADD" OnClick="btnUpdate_Click"/>
                    </td>
                </tr>
            </table>
        </asp:Panel>
