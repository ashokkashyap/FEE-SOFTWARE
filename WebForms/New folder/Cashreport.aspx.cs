        ...
        //try
        {
            if (chkdetails.Checked == false)
            {
               ...
               // Response.End();
                ...
                _Command.CommandText = "select sum(a.AMOUNT_PAID ) from collect_component_detail a where a.paid_date = '" + Convert.ToDateTime(txtStartDate.Text).ToString("yyyy-MM-dd") + "' AND a.MODE='CASH'";
