...
public partial class WebForms_StudentSearchbyName : System.Web.UI.Page
{
    ...
    protected void btnGetDetails_Click(object sender, EventArgs e)
    {
        ...
        Session["Stdid"] = Convert.ToString(RegNo);
        Page.ClientScript.RegisterClientScriptBlock(typeof(Page), "Script", "window.open('StudentLedgerPrint.aspx?class_id=" + ddlSelectClass.SelectedValue + "&STUDENT_id=" + RegNo + "');", true);
    ...
    protected void btnCollectFee_Click(object sender, EventArgs e)
    {
        var _btnCollectFee = (ImageButton)sender;
        var _row = (GridViewRow)_btnCollectFee.NamingContainer;
        var hfFEEStudentID = (HiddenField)_row.FindControl("hfFEEStudentID");
        //Response.Write(hfStudentID.Value); Response.End();
        Session["_STUDENT_ID"] = Convert.ToString(hfFEEStudentID.Value);
        Response.Redirect("CollectFeeFromStudentID.aspx");
        Response.End();
    }
}