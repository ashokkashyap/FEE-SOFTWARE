...
public partial class WebForms_Duplicate_Fee_Recept : System.Web.UI.Page
{
    ...
    protected void btnGetDetails_Click(object sender, EventArgs e)
    {
        ...
        SQL = "select a.student_id, concat(b.FIRST_NAME,' ',b.MIDDLE_NAME,' ',b.LAST_NAME) as name,b.FATHER_NAME,concat(c.CLASS_NAME,' ',c.CLASS_SECTION) as CLASS , a.AMOUNT_PAID,date_format(a.PAID_DATE,'%e-%M-%Y') as pay_date,a.MODE,a.id  from collect_component_detail a ,ign_student_master b , ign_class_master c where a.STUDENT_ID=b.STUDENT_ID and c.class_code=b.class_code and b.STUDENT_REGISTRATION_NBR='" + RegNo + "'  order by a.STUDENT_ID";
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        else if (chkschool.Checked == true)
        {
            recipt_print = "school";
        }

        else if(chkboth.Checked==true)
        {
            recipt_print = "both";
        }
      ...
      Page.ClientScript.RegisterStartupScript(this.GetType(), "OpenWindow", "window.open('DuplicateFee_recipt_Print.aspx','_newtab');", true);
