...
public partial class WebForms_collectionReportDateWisecumPeriodWise : System.Web.UI.Page
{
    ...
    private HtmlTable FuncGetColectionPriodWise1()
    {
       ...
       // _Command.CommandText = "CALL `spComponentMaster`()"; _Command.CommandType = CommandType.StoredProcedure;
        _Command.CommandText = "select distinct cm.COMPONENT_ID,cm.COMPONENT_NAME,cm.COMPONENT_FREQUENCY,cm.START_MONTH, cm.START_YEAR,cm.PRIORITY from component_master cm ,collect_component_master b  where b.PAID_DATE is not null and cm.COMPONENT_ID=b.COMPONENT_ID and month(b.MAPPED_DATE)  between '" + Convert.ToDateTime(txtStartDate.Text).ToString("MM") + "' and '" + Convert.ToDateTime(txtEndDate.Text).ToString("MM") + "' and b.PAID_DATE between '" + Convert.ToDateTime(txtStartDate.Text).ToString("yyyy-MM-dd") + "' and '" + Convert.ToDateTime(txtEndDate.Text).ToString("yyyy-MM-dd") + "' order by cm.PRIORITY";
        ...
        foreach (DateTime _PaidDate in lsPaidDates)
        {
            ...
            objHtmlTableCell = new HtmlTableCell(); objHtmlTableCell.Attributes.Add("style", "color:green; font-weight:bold; font-size:12px"); objHtmlTableCell.InnerText = "Class"; objHtmlTableCell.Align = "center"; objHtmlTableRow.Cells.Add(objHtmlTableCell);
            ...
            {
                if (kvp.Value.ToUpper().Contains("TUITION FEE"))
                {
                    objHtmlTableCell = new HtmlTableCell(); objHtmlTableCell.Attributes.Add("style", "color:green; font-weight:bold; font-size:12px"); objHtmlTableCell.InnerText ="TUT FEE"; objHtmlTableCell.Align = "center"; objHtmlTableRow.Cells.Add(objHtmlTableCell);


                }
                    else if(kvp.Value.ToUpper().Contains("DEV. CHARGES"))
                {

                    objHtmlTableCell = new HtmlTableCell(); objHtmlTableCell.Attributes.Add("style", "color:green; font-weight:bold; font-size:12px"); objHtmlTableCell.InnerText = "DEV. CHRG"; objHtmlTableCell.Align = "center"; objHtmlTableRow.Cells.Add(objHtmlTableCell);
            ...
            objHtmlTableCell = new HtmlTableCell(); objHtmlTableCell.Attributes.Add("style", "color:green; font-weight:bold; font-size:12px"); objHtmlTableCell.InnerText = "R.ADM CHAR"; objHtmlTableCell.Align = "center"; objHtmlTableRow.Cells.Add(objHtmlTableCell);
            objHtmlTableCell = new HtmlTableCell(); objHtmlTableCell.Attributes.Add("style", "color:green; font-weight:bold; font-size:12px"); objHtmlTableCell.InnerText = "CHQ"; objHtmlTableCell.Align = "center"; objHtmlTableRow.Cells.Add(objHtmlTableCell);
            ...
            objHtmlTableCell = new HtmlTableCell(); objHtmlTableCell.Attributes.Add("style", "color:green; font-weight:bold; font-size:12px"); objHtmlTableCell.InnerText = "G TOTAL"; objHtmlTableCell.Align = "center"; objHtmlTableRow.Cells.Add(objHtmlTableCell);
            ...
            foreach (CollectionOtherDetails objCollectionOtherDetails in lsCollectionOtherDetails)
            {
                ...
                Response.Write(objCollectionOtherDetails.StudentID);
            ...
            _Command.CommandText = "select  ifnull(sum(a.amount_paid),0) as samtpaid from collect_component_detail a where   a.MODE= 'CHEQUE' and  paid_date = '" + _PaidDate.ToString("yyyy-MM-dd") + "' ";
