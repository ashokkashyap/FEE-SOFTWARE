...
public partial class WebForms_Collect_feeBY_NameSearch : System.Web.UI.Page
{
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        _Command.CommandText = "select a.STUDENT_REGISTRATION_NBR from ign_student_master a  where a.STUDENT_ID='" + hfStudentID.Value + "'";
      string i=  _Command.ExecuteScalar().ToString();
      Session["STUDENT_REGISTRATION_NBR"] = Convert.ToString(i);
        Response.Redirect("collectFeeAdmissionNo.aspx");
    }
}