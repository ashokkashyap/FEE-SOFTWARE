...
public partial class WebForms_DuplicateFee_recipt_Print : System.Web.UI.Page
{
    ...
    public void feeBillName()
    {
        ...
        if (!IsPostBack)
        {
            ...
            foreach (string varStudentId in objArrayListStudentId)
            {
                ...
                objHtmlTable1 = new HtmlTable(); objHtmlTable1.Border = 0; objHtmlTable1.Attributes.Add("style", "font-size:11px;");

                objHtmlTable2 = new HtmlTable(); objHtmlTable2.Border = 0; objHtmlTable2.Attributes.Add("style", "font-size:11px;");
                ...
                while (objDtReader.Read())
                {
                    ...
                    objHtmlTableRow1 = new HtmlTableRow();
                    objHtmlTableCell1 = new HtmlTableCell();
                    objHtmlTableCell1.InnerText = "Concession : N/A";
                    objHtmlTableCell1.ColSpan = 6;
                    ...
                    objHtmlTableRow2 = new HtmlTableRow();
                    objHtmlTableCell2 = new HtmlTableCell();
                    objHtmlTableCell2.InnerHtml = "Concession :N/A ";
                    objHtmlTableCell2.ColSpan = 6;
                ...
                objHtmlTableRow1 = new HtmlTableRow();
                objHtmlTableCell1 = new HtmlTableCell();
                objHtmlTableCell1.InnerText = "NOTE : 1. Fee,Charges,Fund,Once paid are not refundable. ";
                objHtmlTableCell1.ColSpan = 6;
                ...
                objHtmlTableRow1 = new HtmlTableRow();
                objHtmlTableCell1 = new HtmlTableCell();
                objHtmlTableCell1.InnerText = "note: 2. Cheque subject to encashment";
                objHtmlTableCell1.ColSpan = 8;
                objHtmlTableCell1.Style.Add("border-bottom", "solid 1px black");
                objHtmlTableCell1.Style.Add("border-left", "solid 1px black");
                objHtmlTableCell1.Style.Add("border-right", "solid 1px black");
                ...
                objHtmlTableRow2 = new HtmlTableRow();
                objHtmlTableCell2 = new HtmlTableCell();
                objHtmlTableCell2.InnerText = "PAY MODE : " + Convert.ToString(Session["mode"] + "  " + Convert.ToString(Session["checkno"]) + "  " + Convert.ToString(Session["checkdate"]) + "  " + Convert.ToString(Session["bankdetail"]));
                objHtmlTableCell2.ColSpan = 6;
                objHtmlTableCell2.Style.Add("border-left", "solid 1px black");
                objHtmlTableRow2.Cells.Add(objHtmlTableCell2);
                objHtmlTable2.Rows.Add(objHtmlTableRow2);
                ...
                objHtmlTableRow2 = new HtmlTableRow();
                objHtmlTableCell2 = new HtmlTableCell();
                objHtmlTableCell2.InnerText = "NOTE :1. Fee,Charges,Fund,Once paid are not refundable. ";
                objHtmlTableCell2.ColSpan = 6;
                ...
                objHtmlTableRow2 = new HtmlTableRow();
                objHtmlTableCell2 = new HtmlTableCell();
                objHtmlTableCell2.InnerText = "NOTE :2. Cheque subject to encashment ";
                objHtmlTableCell2.ColSpan = 8;
                objHtmlTableCell2.Style.Add("border-bottom", "solid 1px black");
                objHtmlTableCell2.Style.Add("border-left", "solid 1px black");
                objHtmlTableCell2.Style.Add("border-right", "solid 1px black");
