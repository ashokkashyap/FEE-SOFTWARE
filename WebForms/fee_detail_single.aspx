<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fee_detail_single.aspx.cs" Inherits="WebForms_fee_detail_single" %>
                        ...
                        <asp:GridView ID="gvRecords" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Amount" DataField="AMOUNT_PAID" />
                                    <asp:BoundField HeaderText="R.NO" DataField="Rno" />
                                ...
                                <asp:TemplateField HeaderText="Submit">                                   
                                   <ItemTemplate>
                                       <asp:Button ID="btnSubmit" runat="server" onclientclick="return confirm('Do you want to delete this record?');"  OnClick="Button1_OnClick" Text="Delete" />
