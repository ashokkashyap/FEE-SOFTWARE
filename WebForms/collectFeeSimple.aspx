<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.master" AutoEventWireup="true" CodeFile="collectFeeSimple.aspx.cs" Inherits="WebForms_collectFeeSimple" %>
        ...
        <asp:Panel ID="mainPanel" runat="server">
            <table cellpadding="0" cellspacing="5" width="90%" border="0" style="border-color: Black;">
                ...
                <tr>
                    ...
                    <td class="Calibri14N" style="padding-left: 10px; border-bottom: 1px ridge grey; width: 25%">Calculation Date <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCalculationDate" ErrorMessage="*" ForeColor="Red" ValidationGroup="v1"></asp:RequiredFieldValidator>
                    </td>
