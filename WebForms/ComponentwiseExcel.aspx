<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.master" AutoEventWireup="true" CodeFile="ComponentwiseExcel.aspx.cs" Inherits="WebForms_ComponentwiseExcel" %>
                ...
                <tr>
                    <td valign="bottom" colspan="4" align="left" style="color: #FFAB60; font-family: Calibri;
                        ...
                        <div style="background-color: #FFFF99; border-top: 2px solid #FFAB60; border-left: 2px solid #FFAB60;
                            ...
                            width: 333px; height: 25px; padding-left: 8px;">
                            Collection Report (Component wise)
                        </div>
                    </td>
                </tr>
                <tr>
                 ...
                 <td class="Calibri14N" style="padding-left: 15px; border-bottom: 1px ridge grey;
                        width: 23%; letter-spacing: 1px;">Component:</td>
                    <td colspan="1">
                        <br />
