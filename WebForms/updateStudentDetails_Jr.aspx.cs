...
public partial class WebForms_updateStudentDetails_Jr : System.Web.UI.Page
{
    ...
    {
        using (var ObjConnection = new OdbcConnection(ConfigurationManager.ConnectionStrings["DBConnectJR"].ConnectionString))
        {
            ObjConnection.Open();
        ...
        Page.ClientScript.RegisterClientScriptBlock(typeof(Page), "Script", "alert('Record Updated !!!.'); window.location.href='updateStudentDetails_Jr.aspx';", true);
    }
}