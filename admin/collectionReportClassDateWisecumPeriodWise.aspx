<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="collectionReportClassDateWisecumPeriodWise.aspx.cs" Inherits="admin_collectionReportClassDateWisecumPeriodWise" %>
            ...
            <table cellpadding="0" cellspacing="5" width="90%" border="0" style="border-color: Black;">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td colspan="2" style="border-bottom: 1px ridge grey; width:30%">
